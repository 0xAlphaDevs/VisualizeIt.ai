...
const Navbar = () => {
  ...
  return (
    <div className='mx-16 my-6 px-8 py-2 flex items-center gap-24 shadow-md border border-blue-200 bg-blue-400 bg-opacity-15 rounded-full '>
      <Link href="/dashboard" className="font-sans italic text-4xl text-black">
        VisualizeIt
